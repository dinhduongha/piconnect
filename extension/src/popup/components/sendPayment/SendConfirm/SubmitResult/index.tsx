      ...
      case RESULT_CODES.op_no_destination:
        ...
        errorDetails.errorBlock = (
          <InfoBlock variant={InfoBlock.variant.error}>
            <div>
              {t(
                "The destination account doesn’t exist. Make sure it is a funded Pi Network account and try again.",
              )}
              <TextLink
                underline
                variant={TextLink.variant.secondary}
      ...
      case RESULT_CODES.op_low_reserve:
        ...
        errorDetails.errorBlock = (
          <InfoBlock variant={InfoBlock.variant.error}>
            <div>
              {t(
                "To create a new account you need to send at least 1 PI to it.",
              )}
              <TextLink
                underline
                variant={TextLink.variant.secondary}
