...
export const HistoryItem = ({
  ...
  const date = new Date(Date.parse(createdAt))
    ...
    .slice(1, 3)
    .join(" ");
  const srcAssetCode = sourceAssetCode || "PI";
  const destAssetCode = assetCode || "PI";
  ...
  if (isSwap) {
    ...
    PaymentComponent = <>-{new BigNumber(startingBalance).toFixed(2, 1)} PI</>;
    ...
    transactionDetailProps = {
      ...
      operationText: `-${new BigNumber(startingBalance)} PI`,
    };
  } else {
