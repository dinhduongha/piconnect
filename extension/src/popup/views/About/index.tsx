    ...
    <div className="About">
      ...
      <div className="About__body">
        <div className="About__info">
          {t(
            "PiConnect is a non-custodial wallet extension that enables you to sign Pi Network transactions via your browser. It’s a safer alternative to copying and pasting private keys for use with web apps.",
          )}
        </div>
